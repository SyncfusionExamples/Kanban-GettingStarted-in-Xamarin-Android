...
This repository contains sample on How to get started with the Syncfusion Xamarin.Android SfKanban control

## Syncfusion controls:

This project used the following Syncfusion control(s):
* [SfKanban](https://help.syncfusion.com/cr/xamarin-android/Syncfusion.SfKanban.Android.SfKanban.html)
